<template><div><h1 id="函数" tabindex="-1"><a class="header-anchor" href="#函数"><span>函数</span></a></h1>
<h2 id="消息相关" tabindex="-1"><a class="header-anchor" href="#消息相关"><span>消息相关</span></a></h2>
<ul>
<li>
<p>发送好友信息</p>
...
<h2 id="群聊" tabindex="-1"><a class="header-anchor" href="#群聊"><span>群聊</span></a></h2>
<ul>
<li>戳一戳：<code v-pre>$戳一戳 群 QQ$</code>
示例:<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">戳我</span>
<span class="line">我戳！</span>
<span class="line">$戳一戳 %群号% %QQ%$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>禁言：<code v-pre>$禁 群号 QQ 时间$</code></li>
<li>全体禁言/解禁：<code v-pre>$全体禁言 开/关 群号$</code></li>
<li>撤回消息：<code v-pre>$撤回 群号 Msgbar$</code></li>
<li>改名片：<code v-pre>$改 群号 QQ 新名片$</code></li>
<li>设置群头衔：<code v-pre>$群头衔 群号 QQ 头衔内容$</code></li>
<li>获取群昵称：<code v-pre>$群昵称 群号 QQ$</code></li>
<li>进群审核：<code v-pre>$进群审核 群号 QQ 2001/31 11/12 0$</code></li>
<li>申请加群：<code v-pre>$申请群 群号 理由$</code></li>
<li>退群：<code v-pre>$退出群 群号$</code></li>
<li>踢出群成员：<code v-pre>$踢 群号 QQ$</code></li>
<li>获取群状态：<code v-pre>$获取群状态 群号$</code></li>
<li>设置群状态：<code v-pre>$设置群状态 群号 开/关$</code></li>
<li>获取群列表：<code v-pre>$获取群列表$</code>
<ul>
<li>获取机器人所有的群，输出为json数组</li>
</ul>
</li>
<li>获取群成员：<code v-pre>$获取群成员 群号$</code>
<ul>
<li>获取机器人在的群的群成员[当然要在，不然你不是耍流氓呢吗？]，输出为json</li>
</ul>
</li>
</ul>
<h2 id="好友" tabindex="-1"><a class="header-anchor" href="#好友"><span>好友</span></a></h2>
<ul>
<li>点赞：<code v-pre>$点赞 QQ 数量$</code></li>
</ul>
<h2 id="qr主程序" tabindex="-1"><a class="header-anchor" href="#qr主程序"><span>QR主程序</span></a></h2>
<ul>
<li>
<p>获取qr主程序，群列表回复开关 <code v-pre>$获取群状态 群号$</code>
示例:</p>
<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">获取群状态([0-9]+)</span>
<span class="line">$获取群状态 %括号1%$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>设置qr主程序，群列表回复开关 <code v-pre>$设置群状态 群号 开/关$</code>
示例:</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>使用QR对触发者或指定账号点赞 <code v-pre>$点赞 QQ 数量$</code></p>
<ul>
<li>需登陆QR账号与被点赞账号处于好友关系或被点赞账号开启允许陌生人点赞功能</li>
<li>若登陆QR账号拥有超级会员数量处可更改为20
示例:</li>
</ul>
...
<h2 id="词库" tabindex="-1"><a class="header-anchor" href="#词库"><span>词库</span></a></h2>
<ul>
<li>
<p>添加/删除词库</p>
...
<li>
<p>判定是否是词库管理员 <code v-pre>$管理员 QQ$</code> <br>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p><code v-pre>$添加管理员 QQ$</code></p>
</li>
<li>
<p><code v-pre>$删除管理员 QQ$</code> <br>
示例:</p>
...
<h2 id="调用" tabindex="-1"><a class="header-anchor" href="#调用"><span>调用</span></a></h2>
<ul>
<li>
<p>常调 <code v-pre>$常调 内容$</code> 不能调用带有内部标签的指令，一般配合总处理使用。
示例:</p>
...
<li>
<p>回调 <code v-pre>$回调 内容$</code> 能用所有指令，包括带有内部标签的指令。
示例:</p>
<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">测试</span>
<span class="line">成功</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>回调内部 <code v-pre>$回调内部 内容$</code> 回调获取返回的数值，可以当指令使用。
示例:</p>
...
<li>
<p>调用 <code v-pre>$调用 1000 内容$</code> 有无内部标签均可调用，1000是时间延迟，1000=1s，内容为调用指令。
示例:</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在某一个时间戳达到时开始调用，时间戳为毫秒级
<code v-pre>$调用 时间戳 1649842305965 内容$</code>
示例:</p>
<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">你好</span>
...
<h2 id="取操作" tabindex="-1"><a class="header-anchor" href="#取操作"><span>取操作</span></a></h2>
<ul>
<li>取变量：<code v-pre>$取变量 Name$</code>
示例：</li>
</ul>
...
<li>取括号：<code v-pre>$取括号 内容 正则表达式$</code>
示例:</li>
</ul>
<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">取</span>
...
<li>取中间：<code v-pre>$取中间 分割符 内容分割符左边内容分割符右边内容$</code>
示例:</li>
</ul>
<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">测试</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="网络请求" tabindex="-1"><a class="header-anchor" href="#网络请求"><span>网络请求</span></a></h2>
<ul>
<li>访问网址<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$访问 链接$</span>
<span class="line"></span>
...
<li>下载<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$下载 路径 直连地址$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div>【下载文件到手机】请勿使用非法用途。默认路径为根目录。可以用作下载图片</li>
</ul>
<h2 id="本地文件" tabindex="-1"><a class="header-anchor" href="#本地文件"><span>本地文件</span></a></h2>
<ul>
<li>
<p>下载文件 <code v-pre>$下载 根目录路径 链接$</code>
示例:</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>下载文件，自定义头 <code v-pre>$下载 根目录路径 链接 JSON格式的Headers A$</code></p>
</li>
<li>
<p>删除文件 <code v-pre>$删除 根目录路径$</code></p>
<ul>
<li>删除词库，执行将会删除dic.txt文件</li>
<li>删除文件，现在也可以删除文件夹了
示例:</li>
</ul>
<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$删除 /storage/emulated/0/QR/QRDic/dic.txt$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>清空文件</p>
...
<li>
<p>读写本地文件 <code v-pre>$写文件 根目录路径 内容$</code> <code v-pre>$读文件 根目录路径$</code>
示例:</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>不覆盖写入<code v-pre>[\n\r]([\s\S]+)</code>【搭配读写即可实现在原文件内容后进行续写而非直接覆盖原有文件】</p>
...
<h2 id="本地配置读写" tabindex="-1"><a class="header-anchor" href="#本地配置读写"><span>本地配置读写</span></a></h2>
<ul>
<li><code v-pre>$读 文件路径 key value$</code></li>
<li><code v-pre>$写 文件路径 Key 默认值$</code> 当文件为空的时候，默认值是什么就会读取什么</li>
<li>读写的路径都是从 <code v-pre>/storage/emulated/0/QR/QRDic/data</code> 开始</li>
<li>即 <code v-pre>$写 1 1 1$</code> 会在 <code v-pre>/storage/emulated/0/QR/QRDic/data</code> 下生成一个叫 <code v-pre>1</code> 的文件而不是在根目录 <code v-pre>/storage/emulated/0/</code> 下生成</li>
<li>读同理</li>
</ul>
<p>示例:</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="编码-加密" tabindex="-1"><a class="header-anchor" href="#编码-加密"><span>编码/加密</span></a></h2>
<ul>
<li>转码解码URL格式
<ul>
<li>在访问url的时候，如果提交的参数是一个url，就需要考虑下是否需要进行url编码。</li>
</ul>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>转码解码HEX格式<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$HexDecoder 内容$</span>
<span class="line">$HexEncoder 内容$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>转码解码BASE64格式<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$Base64Decoder 内容$</span>
...
<ul>
<li>转md5格式，不可逆<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$MD5 内容$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>转码CRC32格式，不可逆<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$CRC32 内容$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ul>
...
<li>字符/字节长度<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$字符长度 内容$</span>
...
<li>转大写/小写<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$转大写 内容$</span>
<span class="line">$转小写 内容$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div>示例:<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$转大写 h$</span>
<span class="line">$转小写 H$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>数字转中文<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$数字转中文 数字$</span>
<span class="line"></span></code></pre>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div>结果是→壹壹肆伍壹 <br>
(小数点不报，保留两位小数四舍五入，就算是整数也会报零零如下)<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$数字转中文 114514$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div>结果为→壹壹肆伍壹肆零零<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$数字转中文 单位 数字$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div>单位不明，未实验出结果</li>
</ul>
<h2 id="替换" tabindex="-1"><a class="header-anchor" href="#替换"><span>替换</span></a></h2>
<ul>
<li>替换内容：<code v-pre>$替换 分割符 内容分割符被替换内容分割符要替换内容$</code>
示例:</li>
</ul>
<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">测试</span>
...
<li>正则替换：<code v-pre>$正则 分割符 内容分割符正则表达式分割符要替换内容$</code>
示例:</li>
</ul>
<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">测试</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="随机数" tabindex="-1"><a class="header-anchor" href="#随机数"><span>随机数</span></a></h2>
<ul>
<li>
<p>随机字符</p>
...
<h2 id="时间" tabindex="-1"><a class="header-anchor" href="#时间"><span>时间</span></a></h2>
<ul>
<li>
<p>毫秒级时间戳转时间格式</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>可拆 <code v-pre>$时间 yyyy$$时间 MM$</code>等
兼容普通词库写法为</p>
...
<h2 id="申请群和退出群-要授权" tabindex="-1"><a class="header-anchor" href="#申请群和退出群-要授权"><span>申请群和退出群 要授权</span></a></h2>
<p>机器人加群申请可能会被tx屏蔽，目前大多数情况下无法使用</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="线程" tabindex="-1"><a class="header-anchor" href="#线程"><span>线程</span></a></h2>
<ul>
<li>线程池<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$线程池 执行列表$</span>
<span class="line">$线程池 列队列表$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div></li>
</ul>
<h2 id="执行代码" tabindex="-1"><a class="header-anchor" href="#执行代码"><span>执行代码</span></a></h2>
<ul>
<li>执行<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$执行 内容$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div>示例:<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">执行[\n\r]([\s\S]*)</span>
<span class="line">如果:%QQ%==%主人%</span>
<span class="line">$执行 %括号1%$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>延迟执行<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$延迟执行 1000 内容$</span>
<span class="line">1000为时间延迟，1000=1s</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div>示例:<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">延迟执行([0-9]+) ?[\n\r]([\s\S]*)</span>
<span class="line">如果:%QQ%==%主人%</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>执行JAVA代码<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$BSH BSH 函数名 参数 …$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ul>
<h2 id="图片操作" tabindex="-1"><a class="header-anchor" href="#图片操作"><span>图片操作</span></a></h2>
<ul>
<li>图片转链接<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">$图片链接 内容$</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div>示例: 搭配获取图片MD5变量 <code v-pre>%IMG0%</code> 使用即可直接把图片转换为链接<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">取图链接.*</span>
...
<h2 id="画布" tabindex="-1"><a class="header-anchor" href="#画布"><span>画布</span></a></h2>
<ul>
<li>
<p>声明画布：</p>
...
<li><code v-pre>$画布(固定) 图片(固定) (声明里的画布名) (插入的图片路径) (截取图左上角横坐标x1) (截取图左上角纵坐标y1) (截取图右下角横坐标x2) (截取图右下角纵坐标y2) (放在画布上的位置-左上角横坐标X1) (放在画布上的位置-左上角纵坐标Y1) (放在画布上的位置-右下角横坐标X2) (放在画布上的位置-右下角纵坐标Y2)$</code></li>
...
<h2 id="渲染" tabindex="-1"><a class="header-anchor" href="#渲染"><span>渲染</span></a></h2>
<p>待补充，可先查看 <a href="#%E6%B8%B2%E6%9F%93%E4%BE%8B%E5%AD%90">渲染例子</a></p>
<h2 id="计算" tabindex="-1"><a class="header-anchor" href="#计算"><span>计算</span></a></h2>
<p>（本人表示看不懂，直接照搬了）</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">部分指令内容可参照取整函数，描述抽象请理解</span>
<span class="line">##普通运算，经典向负无穷取整</span>
<span class="line">[1+1-2*1/1]</span>
<span class="line"></span>
<span class="line">##高级运算，保留小数点</span>
<span class="line">十进制[可无视前缀](下同)</span>
<span class="line">丨        保留小数点的位数【计算结果位数超出设置会向下取整】</span>
<span class="line">丨        丨   (为0则为经典向负无穷取整)</span>
<span class="line">丨        丨冒号开算(下同)</span>
<span class="line">丨        丨丨  计算部分(下同)</span>
<span class="line">↓        ↓↓  ↓</span>
<span class="line">[decimal-16:1+1-2*1/1/3]</span>
<span class="line"></span>
<span class="line">【下边的几个感觉一般都用不到】</span>
<span class="line">【如果位数设置没有发生取舍则输出原结果】</span>
<span class="line">          保留的小数点位数范围(下同)</span>
<span class="line">          丨 丨 向正无穷方向取整(如最高保留两位时-1.333→-1.33，1.333→1.34)</span>
<span class="line">          ↓ ↓   ↓</span>
<span class="line">[decimal-0-16-CEILING:1+1-2*1/1/3]</span>
<span class="line"></span>
<span class="line"> 舍去位数后向0取整(如最高保留两位时-1.333→-1.33，1.333→1.33)</span>
<span class="line">[decimal-0-16-DOWN:1+1-2*1/1/3]</span>
<span class="line"></span>
<span class="line"> 舍去位数后向负无穷舍入(如最高保留两位时-1.333→-1.34，1.333→1.33)</span>
<span class="line">[decimal-0-16-FLOOR:1+1-2*1/1/3]</span>
<span class="line"></span>
<span class="line">向距离最近(数轴)的一边取整，两边的距离相等向下取整</span>
<span class="line">【五舍六入，五后有数则进位】</span>
<span class="line">(如最高保留两位1.045→1.04，1.0451→1.05，1.046→1.05)</span>
<span class="line">[decimal-0-16-HALF_DOWN:1+1-2*1/1/3]</span>
<span class="line"></span>
<span class="line">四舍六入五取偶</span>
<span class="line">【取偶指对五前一位是奇数则向上取偶，偶数则舍，若五后仍有数则进位】</span>
<span class="line">(如最高保留两位1.045→1.04，1.0451→1.05，1.046→1.05，1.055→1.06等)</span>
<span class="line">[decimal-0-16-HALF_EVEN:1+1-2*1/1/3]</span>
<span class="line"></span>
<span class="line">向距离最近的一边取整，两边的距离相等向上取整</span>
<span class="line">【四舍五入】</span>
<span class="line">[decimal-0-16-HALF_UP: 1+1-2*1/1/3]</span>
<span class="line"></span>
<span class="line">计算结果不舍入【位数上下限范围必须大于算出来的位数，不然弹码】</span>
<span class="line">[decimal-0-16-UNNECESSARY:1+1-2*1/1/3]</span>
<span class="line"></span>
<span class="line">向远离0的方向取整</span>
<span class="line">[decimal-0-16-UP:1+1-2*1/1/3]</span>
<span class="line"></span>
<span class="line">暂测跟DOWN一样</span>
<span class="line">[decimal-0-16-DOWN-3:1+1-2*1/1/3]</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="红包-失效" tabindex="-1"><a class="header-anchor" href="#红包-失效"><span>红包(失效)</span></a></h2>
<ul>
...
<h2 id="访问本机文件-获取文件内容" tabindex="-1"><a class="header-anchor" href="#访问本机文件-获取文件内容"><span>访问本机文件，获取文件内容</span></a></h2>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="一些qq官方接口需要的" tabindex="-1"><a class="header-anchor" href="#一些qq官方接口需要的"><span>一些QQ官方接口需要的</span></a></h2>
<ul>
<li>BKN值获取</li>
</ul>
<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">测试</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li><code v-pre>$SIG 内容$</code></li>
<li><code v-pre>$GKB 内容路径$</code></li>
</ul>
<h2 id="入群申请例子" tabindex="-1"><a class="header-anchor" href="#入群申请例子"><span>入群申请例子</span></a></h2>
...
<span class="line">如果尾</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="qq群管例子" tabindex="-1"><a class="header-anchor" href="#qq群管例子"><span>QQ群管例子</span></a></h2>
<ul>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div>示例:<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">[系统]</span>
<span class="line">如果:%Value%==1</span>
...
<h2 id="渲染例子" tabindex="-1"><a class="header-anchor" href="#渲染例子"><span>渲染例子</span></a></h2>
<div class="language-qr line-numbers-mode" data-highlighter="prismjs" data-ext="qr" data-title="qr"><pre v-pre><code><span class="line">&amp;&amp;名称:渲染使用🌰词库</span>
<span class="line">&amp;&amp;作者:Doums</span>
<span class="line">&amp;&amp;&lt;配置&gt;版本Code:1</span>
<span class="line">&amp;&amp;&lt;配置&gt;版本名称:1.0</span>
<span class="line">&amp;&amp;&lt;配置&gt;包名:com.doumsg.example.rendering</span>
<span class="line">&amp;&amp;渲染使用🌰词库</span>
<span class="line"></span>
<span class="line"></span>
<span class="line">你好</span>
<span class="line">你好我是词库》》》渲染使用🌰词库《《《</span>
<span class="line"></span>
<span class="line">工作目录</span>
<span class="line">%工作目录%</span>
<span class="line"></span>
<span class="line">路径拼接</span>
<span class="line">path:$路径拼接 /dic/123 eidudh 3161.txt$</span>
<span class="line"></span>
<span class="line">测试</span>
<span class="line">C:\%3C\%68\%31\%3E\%E4\%BD\%A0\%E5\%A5\%BD\%3C\%2F\%68\%31\%3E</span>
<span class="line">P:/img/img%Time%.jpg</span>
<span class="line">$Html渲染 代码 %C% 480 1080 %P%$</span>
<span class="line">渲染结果</span>
<span class="line">J:$路径拼接 %工作目录% %P%$</span>
<span class="line">±img %J%±</span>
<span class="line"></span>
<span class="line">渲染MD ?([\s\S]*)</span>
<span class="line">P:/img/img%Time%.jpg</span>
<span class="line">$Markdown渲染 代码 %括号1% 480 1080 %P%$</span>
<span class="line">OK</span>
<span class="line">J:$路径拼接 %工作目录% %P%$</span>
<span class="line">±img %J%±</span>
<span class="line"></span>
<span class="line">渲染URL参数 ?([\s\S]*)</span>
<span class="line">P:/img/img%Time%.jpg</span>
<span class="line">$Html渲染 代码URL参数 %括号1% 1080 1080 %P% qq=%QQ%$</span>
<span class="line">OK</span>
<span class="line">J:$路径拼接 %工作目录% %P%$</span>
<span class="line">±img %J%±</span>
<span class="line"></span>
<span class="line"></span>
<span class="line">渲染URL ?([\s\S]*)</span>
<span class="line">P:/img/img%Time%.jpg</span>
<span class="line">$Html渲染 URL %括号1% 480 1080 %P%$</span>
<span class="line">OK</span>
<span class="line">J:$路径拼接 %工作目录% %P%$</span>
<span class="line">±img %J%±</span>
<span class="line"></span>
<span class="line"></span>
<span class="line">渲染 ?([\s\S]*)</span>
<span class="line">P:/img/img%Time%.jpg</span>
<span class="line">$Html渲染 代码 %括号1% 1080 1080 %P%$</span>
<span class="line">OK</span>
<span class="line">J:$路径拼接 %工作目录% %P%$</span>
<span class="line">±img %J%±</span>
<span class="line"></span>
